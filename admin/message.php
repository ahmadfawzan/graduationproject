...
<body>
  ...
  ?>
    ...
    <tr>
      ...
      <td><?= $ar['2'] ?></td>
	  <td><?= $ar['1'] ?></td>
	  <td><a href="delete_message.php?id=<?= $ar['0'] ?>" name="cancel"  class="btn btn-danger" onclick="return confirm('Are You Sure to Delete The Message ?');"><i class="far fa-times-circle"></i>&nbsp;DELETE</a></td>
