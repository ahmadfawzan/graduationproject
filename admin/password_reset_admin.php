...
<div class="container">
		...
		<div class="card">
			<div class="card-header">
				...
				<h3 id="ss" >Enter New Password</h3>
					<br>	
			<div class="card-body">
		<form action="password_new_admin.php?code=<?php echo $_GET['code']; ?>&user=<?php echo $_GET['user']; ?>" method="POST">
	...
	<input type="password" name="repassword" id="con" class="form-control" placeholder="Confirm Password" id="myInput" required>
			</div>
	<div class="form-group">

	<h6 style="color:black;" ><input type="checkbox" onclick="myFunction12()">
Show Password</h6>
<script>
